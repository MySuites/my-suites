...
// Ported unchanged from apps/myhealth/targets/live-activity/WorkoutLiveActivity.swift.
// WorkoutActivityAttributes now lives in MyHealthKit so the app target and
// this widget extension share the same type without an Expo bridge.
