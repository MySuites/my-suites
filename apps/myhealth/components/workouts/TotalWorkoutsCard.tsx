      ...
      >
        <View className="flex-col gap-2">
          ...
          <View className="flex-row justify-between items-center">
            ...
            >
              <IconSymbol name="flame.fill" size={16} color={primaryColor || theme.primary} />
            </View>
          ...
          <View>
            ...
            <View className="flex-row items-baseline">
              ...
              <Text className="text-[10px] text-light-muted dark:text-dark-muted ml-0.5">
          ...
          <View className="w-full bg-light dark:bg-dark-lighter rounded-2xl overflow-hidden p-6" style={{ maxHeight: '90%' }}>
            ...
            <View className="flex-row justify-between items-center mb-6">
              <View className="flex-row items-center gap-2">
                <IconSymbol name="flame.fill" size={20} color={primaryColor || theme.primary} />
                <Text className="text-lg font-bold text-light dark:text-dark">Workout Frequency</Text>
              </View>
              <RaisedCard 
            ...
            {history.length > 0 || isLoading ? (
              <View className="w-full">
                <View className="mb-4">
                  ...
                  <View className="flex-row items-baseline flex-wrap mt-2">
                    ...
                    >
                      {displayCount !== null ? displayCount.toLocaleString() : '0'}
                    </Text>
                    <Text className="text-light-muted dark:text-dark-muted text-base mr-3">workout{displayCount !== 1 ? 's' : ''}</Text>
              ...
              <HollowedCard className="p-8 my-4">
                <Text className="text-light-muted dark:text-dark-muted text-center italic">
                  No workout data found. Complete your first workout to see your frequency!
                </Text>
              </HollowedCard>
            )}
          </View>
