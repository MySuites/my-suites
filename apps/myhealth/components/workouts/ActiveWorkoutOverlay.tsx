...
import { FocusedWorkoutScreen } from './FocusedWorkoutScreen';
...
export function ActiveWorkoutOverlay() {
    ...
    const [activeView, setActiveView] = useState<'detail' | 'focused'>('detail');
    ...
    return (
        <>
            ...
            {isExpanded && (
                ...
                >
                    {activeView === 'detail' ? (
                        <ActiveWorkoutDetailScreen onToggleView={() => setActiveView('focused')} />
                    ) : (
                        <FocusedWorkoutScreen onToggleView={() => setActiveView('detail')} />
                    )}
                </Animated.View>
            )}
        </>
