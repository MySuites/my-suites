...
import { TextInput, Alert, KeyboardAvoidingView, Platform, View, Text, ActivityIndicator, Keyboard, TouchableWithoutFeedback, Switch, Modal, FlatList, TouchableOpacity } from 'react-native';
...
function SelectionModal({
    ...
    return (
        ...
        >
            <View className="flex-1 bg-light dark:bg-dark" testID="selection-modal">
                {/* Header */}
